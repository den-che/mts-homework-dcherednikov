    ...
    public HashMap<String, List<AbstractAnimal>> createAnimal(int num) throws InvalidAnimalBirthDateException {
        ...
        for (int idx = 0; idx < num; idx++) {
            ...
            if (Objects.equals("Cat",objValue))
                ...
                objectName = new Wolf("волк", birthdate2,wolfBreed[(int) (Math.random() * wolfBreed.length)],Math.random() * 200.0,area[(int) (Math.random() * area.length)],  characters[(int) (Math.random() * characters.length)]);
            }
